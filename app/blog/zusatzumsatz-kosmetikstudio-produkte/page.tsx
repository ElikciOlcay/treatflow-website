...
import { Calendar, Clock, ArrowRight, Share2, ShoppingBag, TrendingUp, Euro, CheckCircle, AlertCircle, Target, Star } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white">
            ...
            <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify(generateBreadcrumbSchema([
                    ...
                    { label: 'Zusatzumsatz Kosmetikstudio: Produktverkauf' },
                ])) }}
            />
            <Breadcrumbs items={[
                { label: 'Blog', href: '/blog' },
