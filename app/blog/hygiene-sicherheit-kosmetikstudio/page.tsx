...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Hygiene & Sicherheit im Kosmetikstudio: Kompletter Leitfaden',
        description: 'Hygiene-Standards für Kosmetikstudios: Von der Desinfektion bis zur Dokumentation. Alle Vorschriften und praktische Tipps für den Alltag.',
        url: 'https://www.treatflow.io/blog/hygiene-sicherheit-kosmetikstudio',
        siteName: 'Treatflow Blog',
        images: [
            {
                url: '/images/blog/hygiene-sicherheit.jpg',
                width: 1200,
                height: 630,
                alt: 'Hygiene & Sicherheit im Kosmetikstudio: Kompletter Leitfaden',
            },
        ],
        locale: 'de_DE',
        type: 'article',
    ...
    twitter: {
        ...
        title: 'Hygiene & Sicherheit im Kosmetikstudio: Kompletter Leitfaden',
        description: 'Hygiene-Standards für Kosmetikstudios: Von der Desinfektion bis zur Dokumentation. Alle Vorschriften und praktische Tipps für den Alltag.',
        images: ['/images/blog/hygiene-sicherheit.jpg'],
    },
};
...
export default function BlogPost() {
    const structuredData = {
        ...
        "@type": "BlogPosting",
        "headline": "Hygiene & Sicherheit im Kosmetikstudio: Kompletter Leitfaden",
        "description": "Hygiene-Standards für Kosmetikstudios: Von der Desinfektion bis zur Dokumentation. Alle Vorschriften und praktische Tipps für den Alltag.",
        ...
        "datePublished": "2024-11-28T15:00:00.000Z",
        "dateModified": "2024-11-28T15:00:00.000Z",
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "https://www.treatflow.io/blog/hygiene-sicherheit-kosmetikstudio"
        },
        ...
        <div className="min-h-screen bg-white">
            ...
            <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify(generateBreadcrumbSchema([
                    ...
                    { label: 'Hygiene & Sicherheit im Kosmetikstudio' },
                ])) }}
            />
            <Breadcrumbs items={[
                { label: 'Blog', href: '/blog' },
                    ...
                    <div className="border-t border-gray-200 pt-8 mb-12">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                            ...
                            <div className="flex flex-wrap gap-3">
                                <a
                href={`https://twitter.com/intent/tweet?url=${encodeURIComponent('https://www.treatflow.io/blog/hygiene-sicherheit-kosmetikstudio')}&text=${encodeURIComponent('Hygiene & Sicherheit im Kosmetikstudio: Kompletter Leitfaden - Treatflow Blog')}`}
                target="_blank"
            ...
            >
                ...
                Twitter
                                ...
                                <a
                href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://www.treatflow.io/blog/hygiene-sicherheit-kosmetikstudio')}`}
                target="_blank"
                rel="noopener noreferrer"
            ...
            >
                ...
                LinkedIn
                                ...
                                <a
                href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://www.treatflow.io/blog/hygiene-sicherheit-kosmetikstudio')}&quote=${encodeURIComponent('Hygiene & Sicherheit im Kosmetikstudio: Kompletter Leitfaden')}`}
                target="_blank"
                rel="noopener noreferrer"
