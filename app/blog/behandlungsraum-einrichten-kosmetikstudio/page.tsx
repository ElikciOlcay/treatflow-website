...
import { Calendar, Clock, ArrowLeft, ArrowRight, Share2, Home } from 'lucide-react';

export const metadata: Metadata = {
    title: 'Behandlungsraum einrichten: Worauf es ankommt | Treatflow Blog',
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-12">
                        <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl">
                            <img src="/images/blog/behandlungsraum-einrichten.jpg" alt="Behandlungsraum im Kosmetikstudio einrichten" className="w-full h-full object-cover" />
                        </div>
                    </div>
