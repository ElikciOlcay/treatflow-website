...
import { Calendar, Clock, ArrowRight, Share2, Brain, Zap, Camera, CheckCircle, AlertTriangle, Smartphone } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white">
            ...
            <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify(generateBreadcrumbSchema([
                    ...
                    { label: 'KI im Kosmetikstudio: Hautanalyse der Zukunft' },
                ])) }}
            />
            <Breadcrumbs items={[
                { label: 'Blog', href: '/blog' },
