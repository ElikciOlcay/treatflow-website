...
import { Calendar, Clock, ArrowRight, Share2, CheckCircle, AlertTriangle, Users, Zap, TrendingUp, Target, Timer } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white">
            ...
            <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify(generateBreadcrumbSchema([
                    ...
                    { label: 'Terminkalender im Kosmetikstudio optimieren' },
                ])) }}
            />
            <Breadcrumbs items={[
                { label: 'Blog', href: '/blog' },
