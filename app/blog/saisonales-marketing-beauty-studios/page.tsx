...
import { Calendar, Clock, ArrowRight, Share2, Snowflake, Sun, Leaf, Heart, Gift, CheckCircle, TrendingUp } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white">
            ...
            <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify(generateBreadcrumbSchema([
                    ...
                    { label: 'Saisonales Marketing für Beauty-Studios' },
                ])) }}
            />
            <Breadcrumbs items={[
                { label: 'Blog', href: '/blog' },
