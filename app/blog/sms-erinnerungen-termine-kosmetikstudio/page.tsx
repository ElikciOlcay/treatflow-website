...
import { Calendar, Clock, ArrowRight, Share2, MessageSquare } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white">
            ...
            <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify(generateBreadcrumbSchema([
                    ...
                    { label: 'SMS-Erinnerungen für Termine im Studio' },
                ])) }}
            />
            <Breadcrumbs items={[
                { label: 'Blog', href: '/blog' },
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <LeadMagnetEmbed
                    href="/no-show-playbook-kosmetikstudio-pdf"
                    title="No-Show-Playbook zum Download"
                    description="SMS- und E-Mail-Texte plus Checkliste gegen leere Stühle."
                />
            </div>
            ...
            <section className="py-12 bg-gray-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {[
                            { href: '/sms-erinnerungen-kosmetikstudio', title: 'SMS-Erinnerungen Kosmetikstudio', desc: 'Automatische Erinnerungen per SMS und E-Mail' },
                            { href: '/nachrichtenautomatisierung', title: 'Nachrichtenautomatisierung', desc: 'Alle automatischen Nachrichten im Überblick' },
                        ].map((link, i) => (
