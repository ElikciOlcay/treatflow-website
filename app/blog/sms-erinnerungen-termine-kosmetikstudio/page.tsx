...
export const metadata: Metadata = {
    title: 'SMS-Erinnerungen für Termine: Warum sie im Studio ankommen | Treatflow Blog',
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-12">
                        <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl">
                            <img src="/images/blog/sms-erinnerungen-termine.jpg" alt="SMS-Erinnerung für Kosmetiktermin" className="w-full h-full object-cover" />
                        </div>
                    </div>
