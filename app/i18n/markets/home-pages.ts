...
export const enHomePage: HomePageIntlContent = {
  ...
  features: {
    ...
    items: [
      ...
      { icon: Bell, label: "Reminders", desc: "Automatic WhatsApp and emails reduce no-shows.", color: "bg-rose-100 text-rose-600" },
...
export const esHomePage: HomePageIntlContent = {
  ...
  features: {
    ...
    items: [
      ...
      { icon: Bell, label: "Recordatorios", desc: "WhatsApp y emails automáticos reducen las ausencias.", color: "bg-rose-100 text-rose-600" },
...
export const itHomePage: HomePageIntlContent = {
  ...
  features: {
    ...
    items: [
      ...
      { icon: Bell, label: "Promemoria", desc: "WhatsApp ed email automatici riducono le assenze.", color: "bg-rose-100 text-rose-600" },
...
export const frHomePage: HomePageIntlContent = {
  ...
  features: {
    ...
    items: [
      ...
      { icon: Bell, label: "Rappels", desc: "WhatsApp et e-mails automatiques réduisent les absences.", color: "bg-rose-100 text-rose-600" },
