export const trPrivacy = {
  metaTitle: "Gizlilik Politikası",
  metaDescription:
    "Treatflow gizlilik politikası: KVKK kapsamında işleme, Frankfurt'taki AB sunucuları, haklarınız ve salon ile web sitesi verilerinin nasıl işlendiği.",
  title: "Gizlilik Politikası",
  intro:
    "Treatflow, güzellik salonları ve medikal estetik klinikleri için salon yazılımıdır. Kişisel verileri yürürlükteki veri koruma hukuku (Türkiye için KVKK dahil) çerçevesinde işleriz. Yasal olarak tam metin Almanca gizlilik beyanıdır (/datenschutz). Bu sayfa stüdyoların ve müşterilerin en sık sorduğu noktaları özetler.",
  sections: [
    {
      heading: "1. Veri sorumlusu",
      html: `<p>Bu web sitesi ve Treatflow uygulaması için veri sorumlusu:</p>
<p><strong>Treatflow</strong><br/>Olcay Elikci<br/>Bahnhofstrasse 17<br/>5500 Bischofshofen, Avusturya<br/>E-posta: <a href="mailto:hello@treatflow.io">hello@treatflow.io</a></p>`,
    },
    {
...
<p><strong>Uygulama içi (işletme verileri):</strong> işletmenin sakladığı müşteri kayıtları, randevular, formlar, imzalar, işlem notları, fotoğraflar ve fatura verileri. İşletme, kendi müşteri verileri bakımından kural olarak veri sorumlusudur; Treatflow veri işleyen olarak veri işleme sözleşmesi kapsamında hareket eder.</p>`,
    },
    {
      ...
      html: `<ul>
<li>Web sitesi ve yazılımın sunulması (sözleşme / meşru menfaat)</li>
<li>Hesap, faturalama ve destek (sözleşme)</li>
<li>Yasal yükümlülükler (vergi, muhasebe)</li>
<li>İsteğe bağlı analitik ve pazarlama çerezleri yalnızca açık rıza ile</li>
</ul>`,
    },
    {
      heading: "5. Haklarınız",
      html: `<p>Uygulanabilir hukuka göre erişim, düzeltme, silme, kısıtlama, taşınabilirlik talep edebilir ve işlemeye itiraz edebilirsiniz. Bir denetim makamına şikayette bulunabilirsiniz. Avusturya: Datenschutzbehörde. Türkiye'de KVKK kapsamında ilgili kişi haklarınız saklıdır. Bize hello@treatflow.io adresinden yazın.</p>`,
    },
    {
      heading: "6. Tam Almanca metin",
      html: `<p>Çerezler, işleyenler, saklama süreleri ve eksiksiz hukuki metin için <a href="/datenschutz">Almanca gizlilik politikasına</a> bakın.</p>`,
    },
  ],
};
...
export const trTerms = {
  ...
  sections: [
    {
      heading: "1. Hizmet",
      html: `<p>Treatflow randevu, online randevu, müşteri takibi, formlar, işlem kaydı ve ilgili salon araçları için web yazılımı sunar. Pazaryeri değildir ve randevu başına komisyon almaz.</p>`,
    },
    {
    ...
    },
    {
      ...
      html: `<p>Eksiksiz sözleşme metni <a href="/agb">Almanca AGB</a>'dir. Sorular: hello@treatflow.io.</p>`,
    },
  ],
};
