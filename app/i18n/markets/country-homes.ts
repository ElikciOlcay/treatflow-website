...
const usHomePage: HomePageIntlContent = {
  ...
  features: {
    ...
    items: [
      ...
      { icon: Bell, label: "Reminders", desc: "Automatic WhatsApp and email reminders reduce no-shows.", color: featureColors.reminders },
...
const nlHomePage: HomePageIntlContent = {
  ...
  features: {
    ...
    items: [
      ...
      { icon: Bell, label: "Herinneringen", desc: "Automatische WhatsApp- en e-mailherinneringen verminderen no-shows.", color: featureColors.reminders },
...
const fiHomePage: HomePageIntlContent = {
  ...
  features: {
    ...
    items: [
      ...
      { icon: Bell, label: "Muistutukset", desc: "Automaattiset WhatsApp- ja sähköpostimuistutukset vähentävät no-show'ta.", color: featureColors.reminders },
...
const trHomePage: HomePageIntlContent = {
  ...
  cta: {
    title: "Salonunuzu bugün dijitalleştirin",
    subtitle: "Treatflow'u 30 gün ücretsiz deneyin. Kredi kartı gerekmez, taahhüt yok.",
  ...
  return {
    ...
    features: {
      ...
      items: [
        ...
        { icon: Bell, label: "Reminders", desc: "Automatic WhatsApp and email reminders that cut no-shows.", color: featureColors.reminders },
        { icon: Workflow, label: "Digital workflows", desc: "From booking to documentation in one system.", color: featureColors.workflows },
      ],
    },
    extras: {
