                    ...
                    <div className="text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <a href="https://meetings-eu1.hubspot.com/olcay-elikci/treatflow-beratung?uuid=1193ce3c-32b4-42ff-96c6-bb0b6752719f" target="_blank" rel="noopener noreferrer"
                                className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl font-semibold hover:border-indigo-600 hover:text-indigo-600 transition-colors">
                                Beratung buchen
                            </a>
                        </div>
                    </div>
            ...
            <section className="py-12 bg-white">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto">
                        Berlins Beauty-Markt ist wettbewerbsintensiv und vielfältig. Um sich zu behaupten, brauchst du eine einfache Software für Online-Buchungen, eine zentrale Kundenverwaltung und digitale Formulare – alles DSGVO-konform. Treatflow hilft Berliner Studios, effizienter zu arbeiten und ihre internationale Kundschaft optimal zu bedienen.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-indigo-50 rounded-2xl p-8 border border-indigo-100">
                        <div className="flex flex-wrap gap-6 items-center justify-center text-gray-700">
                            ...
                            <span className="flex items-center gap-2"><CheckCircle className="h-5 w-5 text-green-600" /> Genutzt von Studios in Mitte, Charlottenburg, Prenzlauer Berg und ganz Berlin.</span>
                        </div>
                    </div>
                </div>
            </section>
