...
export async function generateMetadata({
  ...
  const content = getMarketIndustryPage(market, "spa-wellness-software");
...
export default async function Page({
  ...
  const market = raw as PrefixedMarket;
  return <InternationalSeoPage content={getMarketIndustryPage(market, "spa-wellness-software")} />;
}
