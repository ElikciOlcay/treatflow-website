...
export async function generateMetadata({
  ...
  const content = getMarketExtraFeaturePage(market, "studio-website");
  return buildPageMetadata({
    pageKey: "studio-website",
    locale: market,
    title: content.title,
...
export default async function Page({
  ...
  const market = raw as PrefixedMarket;
  return <FeaturePageEn {...getMarketExtraFeaturePage(market, "studio-website")} />;
}
