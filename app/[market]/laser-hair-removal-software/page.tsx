...
export async function generateMetadata({
  ...
  const content = getMarketIndustryPage(market, "laser-hair-removal-software");
...
export default async function Page({
  ...
  const market = raw as PrefixedMarket;
  return <InternationalSeoPage content={getMarketIndustryPage(market, "laser-hair-removal-software")} />;
}
