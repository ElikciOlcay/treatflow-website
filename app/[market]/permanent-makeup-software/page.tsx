...
export async function generateMetadata({
  ...
  const content = getMarketIndustryPage(market, "permanent-makeup-software");
...
export default async function Page({
  ...
  const market = raw as PrefixedMarket;
  return <InternationalSeoPage content={getMarketIndustryPage(market, "permanent-makeup-software")} />;
}
