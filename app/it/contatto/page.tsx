...
export const metadata = buildPageMetadata({
  ...
  locale: "it",
  title: "Contatto",
  description: "Contatta il team Treatflow o richiedi l'accesso anticipato per l'Italia.",
});
  ...
  return (
    <section className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-2xl mx-auto text-center">
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Contatto</h1>
        <p className="text-lg text-gray-600 mb-12">
          Hai una domanda su Treatflow? Siamo felici di aiutarti.
        </p>
        ...
        <div className="grid sm:grid-cols-2 gap-6 text-left">
          ...
          >
            ...
            <h2 className="font-bold text-gray-900 mb-1">Scrivici</h2>
          ...
          >
            ...
            <h2 className="font-bold text-gray-900 mb-1">Accesso anticipato</h2>
