...
const reviews = [
    {
        text: 'Treatflow ist die ultimative Lösung für meine Praxis. Unschlagbar im Preis und intuitiv zu bedienen. Die Online-Terminbuchung mit automatischem Versand von Anamnese- und Aufklärungsbögen erspart so viel Zettelwirtschaft!',
    ...
    {
        text: 'Wir sind mehr als zufrieden mit Treatflow! Olcay antwortet immer extrem schnell und setzt Anpassungen so schnell wie möglich nach unseren Bedürfnissen um. Der Support ist wirklich herausragend.',
    ...
    {
        text: 'Ich nutze Treatflow erst seit kurzem, aber bin jetzt schon voll und ganz begeistert. Es erleichtert die Arbeit enorm und ist NiSV-konform. Die Formulare wurden so angepasst wie ich es brauchte.',
        name: 'Nadja Neumann',
    ...
    {
        text: 'Hab von Phorest zu Treatflow gewechselt. Preisleistung ist super. Bei Phorest war ich bei ca. 300 EUR im Monat, bei Treatflow unter 100 EUR. Kann ich mit bestem Gewissen empfehlen.',
