...
export function LandingPrimaryCTA({
    ...
    return (
        <a
            ...
            onClick={() => trackLandingEvent('google_ads_lp_cta_click', landingPage)}
...
export function LandingDemoCTA({
    ...
    return (
        <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => trackLandingEvent('google_ads_lp_demo_click', landingPage)}
...
export function LandingDemoLink({
    label = 'Lieber erst eine Demo buchen?',
    className = '',
    landingPage = 'landing/kosmetikstudio-software',
    ...
    return (
        <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => trackLandingEvent('google_ads_lp_demo_click', landingPage, { placement: 'text_link' })}
