...
const testimonials = [
    ...
    {
        text: 'Ich nutze Treatflow erst seit kurzem für mein Studio, aber bin jetzt schon voll und ganz begeistert. Es erleichtert die Arbeit enorm, denn man hat alles zu jedem Kunden zusammen wie Fotos, Einstellungen von Geräten uvm. und ganz wichtig: es ist NiSV-konform. Die Formulare wurden so angepasst wie ich es brauchte.',
        name: 'Nadja Neumann',
    ...
    {
        text: 'Hab von Phorest zu Treatflow gewechselt. Ich bin super zufrieden. Preisleistung ist super. Bei Phorest war ich bei ca. 300 EUR im Monat, bei Treatflow unter 100 EUR. Das Team ist super schnell und freundlich. Treatflow hat alles abgefangen und reibungslos umgesetzt. Kann ich mit bestem Gewissen empfehlen.',
    ...
    {
        text: 'Ich nutze das System für meine Kundendatenbank im Alltag – und es erleichtert mir wirklich einiges. Es wird auf individuelle Bedürfnisse eingegangen. Eine Funktion, die ich mir gewünscht habe, wurde tatsächlich extra für mich umgesetzt. Der Support ist unkompliziert und schnell erreichbar.',
        name: 'Selina Klingshirn',
        studio: 'Kosmetikstudio',
        initials: 'SK',
        color: 'bg-pink-500',
    },
    {
        text: 'Treatflow überzeugt mit einer benutzerfreundlichen Oberfläche und einem durchdachten Konzept. Die Anwendung läuft tadellos, bietet hilfreiche Funktionen und macht insgesamt einen sehr professionellen Eindruck. Nutze es täglich und bin sehr begeistert! Klare Empfehlung.',
        name: 'Pia Patricia',
        studio: 'Kosmetikstudio',
        initials: 'PP',
        color: 'bg-green-500',
